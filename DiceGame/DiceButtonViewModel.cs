    ...
    class DiceButtonViewModel : ViewModelBase
    {
        public static List<DiceButtonViewModel> GetDiceButtonsViewModels()
        {
            List<DiceButtonViewModel> list = new List<DiceButtonViewModel>()
            {
                ...
                new DiceButtonViewModel(3,new DoubleDice(2){ Odds =11}){Text1="2 Double",DiceControl= new Dice1ViewModel()},
                new DiceButtonViewModel(4,new DoubleDice(3){ Odds =11}){Text1="3 Double",DiceControl= new Dice1ViewModel()},
                ...
                new DiceButtonViewModel(30,new TwoDicePoints(1,2)){Text1="1 and 2"},
                new DiceButtonViewModel(31,new TwoDicePoints(1,3)){Text1="1 and 3"},
                new DiceButtonViewModel(32,new TwoDicePoints(1,4)){Text1="1 and 4"},
                new DiceButtonViewModel(33,new TwoDicePoints(1,5)){Text1="1 and 5"},
                new DiceButtonViewModel(34,new TwoDicePoints(1,6)){Text1="1 and 6"},
                new DiceButtonViewModel(35,new TwoDicePoints(2,3)){Text1="2 and 3"},
                new DiceButtonViewModel(36,new TwoDicePoints(2,4)){Text1="2 and 4"},
                new DiceButtonViewModel(37,new TwoDicePoints(2,5)){Text1="2 and 5"},
                new DiceButtonViewModel(38,new TwoDicePoints(2,6)){Text1="2 and 6"},
                new DiceButtonViewModel(39,new TwoDicePoints(3,4)){Text1="3 and 4"},
                new DiceButtonViewModel(40,new TwoDicePoints(3,5)){Text1="3 and 5"},
                new DiceButtonViewModel(41,new TwoDicePoints(3,6)){Text1="3 and 6"},
                new DiceButtonViewModel(42,new TwoDicePoints(4,5)){Text1="4 and 6"},
                new DiceButtonViewModel(43,new TwoDicePoints(4,6)){Text1="4 and 6"},
                new DiceButtonViewModel(44,new TwoDicePoints(5,6)){Text1="5 and 6"},
